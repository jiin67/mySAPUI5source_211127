		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zproject0921112602unit91e-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zproject0921112602unit91e-display": {
								"semanticObject": "zproject0921112602unit91e",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zproject0921112602unit91e",
									"url": sap.ui.require.toUrl("zproject0921112602unit91e")
								}
							}
						}
					}
